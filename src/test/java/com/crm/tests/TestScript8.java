...
public class TestScript8 {
	...
	AccountService8 accountService8 = null;
	...
	public void init() {
		...
		accountService8 = new AccountService8();
	...
	public void createAccountWithBillingAddress() throws InterruptedException {
		...
		accountService8.clickOnCreateAccount();
		accountService8.insertAccountNameAndEmail();
		accountService8.insertAccountWebSite();
		accountService8.insertPhoneNumber();
		accountService8.insertAccountBillingAddress();
		accountService8.CopyBillingAddress();
		accountService8.SaveTheDetails();
		validation1.validateAccountBillingPostalCode(accountService8);
